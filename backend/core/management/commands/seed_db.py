...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        venue1 = create_venue_with_seats('PVR Director\'s Cut', 'Vasant Kunj, New Delhi', 5, 10)
        venue2 = create_venue_with_seats('PVR ICON IMAX', 'Versova, Mumbai', 6, 10)
        venue3 = create_venue_with_seats('INOX Megaplex', 'Koramangala, Bangalore', 4, 8)
        ...
        create_show_and_seats(e2, venue2, now + datetime.timedelta(hours=4), now + datetime.timedelta(hours=7))
        create_show_and_seats(e3, venue3, now + datetime.timedelta(days=2, hours=8), now + datetime.timedelta(days=2, hours=11))
